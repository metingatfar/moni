...
export class LocalFAQEngine {
  ...
  private initializeEntries() {
    ...
    const rawData = [
      ...
      { id: 'greet1', cat: 'identity', kw: ['merhaba', 'selam', 'hey', 'hello', 'hi'], tr: 'Merhaba! Ben MONI, kişisel yapay zeka asistanınızım. Bugün size nasıl yardımcı olabilirim?', en: 'Hello! I am MONI, your personal AI assistant. How can I help you today?' },
      { id: 'greet2', cat: 'identity', kw: ['günaydın', 'good morning'], tr: 'Günaydın! Harika bir gün dilerim. Bugün ne üzerinde çalışmak istersiniz?', en: 'Good morning! Wish you a great day. What would you like to work on today?' },
      { id: 'greet3', cat: 'identity', kw: ['iyi akşamlar', 'good evening'], tr: 'İyi akşamlar! Günün kalanında size yardımcı olmaktan mutluluk duyarım.', en: 'Good evening! I am happy to assist you with the rest of your day.' },
      { id: 'identity1', cat: 'identity', kw: ['sen kimsin', 'who are you', 'adın ne', 'ismin ne', 'name'], tr: 'Ben MONI, Metin GATFAR tarafından geliştirilmiş kişisel yapay zeka çalışma arkadaşı ve asistanıyım.', en: 'I am MONI, a personal AI workspace companion developed by Metin GATFAR.' },
      ...
      { id: 'identity3', cat: 'identity', kw: ['nasılsın', 'how are you'], tr: 'Harikayım! Tüm yerel servislerim aktif ve size yardım etmeye hazırım. Siz nasılsınız?', en: 'Doing great! All local services are active and ready to assist. How are you?' },
